...
class SpikingNetwork:
    ...
    def input_full_data(self, data, progress_callback=None, report_interval=1000):
        ...
        for i, potential in enumerate(data):
            ...
            # Report progress every report_interval iterations to avoid overhead
